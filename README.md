...
- [x] A functional component is a Java script, but a class Component requires us to be extended from React.
-  Name three lifecycle methods and their purposes.
- [x] Mounting component, Component Update, Component Unmounting - End of component
-  What is the purpose of a custom hook?
- [x] The purpose of a custom hook is to reuse stateful logic
-  Why is it important to test our apps?
- [x] Tests ensures that functionality bugs and usability issues are far and few between.
